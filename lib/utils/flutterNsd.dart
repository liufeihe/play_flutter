    ...
    _channel.setMethodCallHandler((call) {
      switch (call.method) {
        ...
        case 'onServiceResolved':
          ...
          var addresses = call.arguments['addresses'];
          _streamController.add(NsdServiceInfo(hostname, port, name, addresses: addresses));
          break;
        default:
...
class NsdServiceInfo {
  ...
  NsdServiceInfo(this.hostname, this.port, this.name, {this.addresses});
}
